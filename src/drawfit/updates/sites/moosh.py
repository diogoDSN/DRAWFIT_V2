...
class Moosh(Site):
    ...
    async def getOddsLeague(self, session: AsyncHTMLSession,  league_code: MooshCode) -> List[OddSample]:
        """
    ...
    async def build_url(self, session: AsyncHTMLSession):
        ...
        raw_info = await session.get(url="https://kong.sbtech.com/auth/v2/GetTokenBySiteId/151", headers={"User-Agent": "Mozilla/5.0"})
