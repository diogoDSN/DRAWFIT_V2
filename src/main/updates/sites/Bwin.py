...
class Bwin(Site):
    ...
    async def getOddsLeague(self, session: AsyncHTMLSession, leagueId: Dict[str, str]) -> List[OddSample]:
        """
    ...
    def parseResponse(self, leagueInfo) -> List[OddSample]:
        """
    ...
    def addQuery(self, regionID : str ='20', competitionID: str ='102848') -> str:
        query = {}
